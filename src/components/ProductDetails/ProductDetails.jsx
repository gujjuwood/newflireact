...
import "../Home/TextSlider.css"; // For custom animations
...
const ProductDetails = () => {
  ...
  useEffect(() => {
    ...
    if (product?.ProductImages && product?.ProductImages?.length > 0) {
      setSelectedColor(product?.ProductImages?.[0]);
    }
  ...
  useEffect(() => {
    if (selectedColor) {
      ...
      setProductImages((prev) => [
        {
          public_id: selectedColor.public_id,
...
const fetchTextList = async () => {
  try {
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACKEND_BASE_URL}/api/v1/swipper`
    );
    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <MinCategory />
          <main className="sm:mt-0" style={{ marginTop: '113px' }}>
                ...
                <div className="flex flex-col gap-3 m-3">
                  ...
                  <div className="w-full flex gap-3">
                    ...
                    {product.stock > 0 && (
                      ...
                      >
                        <ShoppingCartIcon />
                        {itemInCart ? "GO TO CART" : "GO TO CART"}
                      </button>
                    )}
                    <button
                      onClick={buyNow}
              ...
              <div className="flex-1 py-2 px-3">
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  {Array(3)
                    ...
                    .map((el, i) => (
                      <p className="text-sm flex items-center gap-1" key={i}>
                        ...
                        Instant discount on first Pay Later order of 500 and
                        above{" "}
                  ...
                  {product?.size && product?.size?.length > 0 && (
                    <>
                      <h4 className="text-xl pt-1">Sizes :</h4>
                  ...
                  {product?.ProductImages &&
                    product?.ProductImages?.length > 0 && (
                      <>
                        <h4 className="text-xl pt-1">Colors :</h4>
                        <div className="flex flex-wrap gap-3">
